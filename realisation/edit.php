			...
			<div class="col-6 " style="margin-left:320px" >
				  ...
				  <h2 style="padding-top:30px; color:white">Ajoute les informations</h2>
					...
					<div class="">
									...
									<select class="form-select" class="" required name="Fonction" class="col-6" style="margin-left:180px;width:350px;margin-top:20px; height: 40px; border-radius: 10px;border:1px solid" placeholder="Function"  	aria-label="Default select example">
					...
					<div class="">
						...
						<input type="file" style="width:350px;margin-top:20px;margin-bottom:20px; height: 40px; border-radius: 10px;border:1px solid" class="col-6" value=<?php echo './images/'.$employee->getPhoto(); ?> name="uploadfile"  required >
					</div>
	            <div class="">
